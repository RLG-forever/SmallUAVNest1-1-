...
#define MOTOR_CONTROL_RUN_COMMAND_REG             0x00C8U
#define MOTOR_CONTROL_EMERGENCY_STOP_COMMAND      0x0100U
...
//是否允许调平
#ifndef MOTOR_HOME_LEVEL_ENABLE
#define MOTOR_HOME_LEVEL_ENABLE                    0U
#endif

#define MOTOR_HOME_LEVEL_PAIR_COUNT                4U
#define MOTOR_HOME_LEVEL_ERROR_THRESHOLD           5000L
//拒绝调平最大差值脉冲
#define MOTOR_HOME_LEVEL_MAX_ADJUSTMENT            10000L
...
typedef enum {
    ...
    MOTOR_HOME_STATE_STOP_PAIRED_MOTOR,
    MOTOR_HOME_STATE_SEND_COMMAND,
    MOTOR_HOME_STATE_WAIT_POLL,
    MOTOR_HOME_STATE_CHECK_RUNNING_ALARM,
